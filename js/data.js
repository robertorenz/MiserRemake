...
const GAME = {
  ...
  map: {
    ...
    rooms: {
      front_porch: { x: 2, y: 0, layer: 'ground' },
      foyer: { x: 2, y: 1, layer: 'ground' },
      dining_room: { x: 1, y: 1, layer: 'ground' },
      chinese_room: { x: 0, y: 1, layer: 'ground' },
      kitchen: { x: 0, y: 2, layer: 'ground' },
      pantry: { x: 1, y: 2, layer: 'ground' },
      great_hall: { x: 2, y: 2, layer: 'ground' },
      breakfast_room: { x: 2, y: 3, layer: 'ground' },
      conservatory: { x: 3, y: 3, layer: 'ground' },
      red_room: { x: 3, y: 2, layer: 'ground' },
      parlor: { x: 3, y: 1, layer: 'ground' },
      library: { x: 4, y: 0, layer: 'ground' },
      blue_drawing: { x: 4, y: 1, layer: 'ground' },
      vault_room: { x: 4, y: 2, layer: 'ground' },
      green_drawing: { x: 4, y: 3, layer: 'ground' },
      den: { x: 5, y: 1, layer: 'ground' },
      trophy_room: { x: 5, y: 2, layer: 'ground' },
      game_room: { x: 5, y: 3, layer: 'ground' },
      smoking_room: { x: 4, y: 4, layer: 'ground' },
      portico: { x: 3, y: 4, layer: 'ground' },
      hall_mirrors: { x: 2, y: 4, layer: 'ground' },
      ballroom: { x: 3, y: 5, layer: 'ground' },
      chapel: { x: 4, y: 5, layer: 'ground' },
      back_yard: { x: 0, y: 3, layer: 'ground' },
      forest: { x: 0, y: 4, layer: 'ground' },
      pool_area: { x: -1, y: 3, layer: 'ground' },
      pump_house: { x: -1, y: 4, layer: 'ground' },
      pool_bottom: { x: -2, y: 3, layer: 'ground' },
      maze_a: { x: 1, y: 3, layer: 'ground' },
      maze_b: { x: 1, y: 4, layer: 'ground' },
      maze_c: { x: 1, y: 5, layer: 'ground' },
      maze_d: { x: 2, y: 5, layer: 'ground' },
      maze_e: { x: 0, y: 5, layer: 'ground' },
      maze_f: { x: -1, y: 5, layer: 'ground' },
      dungeon: { x: 2, y: 6, layer: 'ground' },
